...
class TestDualSimplexMethod(unittest.TestCase):
    ...
    def test_case_two(self):
        ...
        ds = DualSimplexMethod(A, c, b, d_down_asterisk, d_up_asterisk)
        self.assertEqual(([3, 0, 4, 1.1818, 0.6364, 1.1818], 36.2727), ds.solve())
    ...
    #     ds = DualSimplexMethod(A, c, b, d_down_asterisk, d_up_asterisk)
    #     self.assertEqual(([3, 5, 0, 1.8779, 2.7545, 3.0965, 6, 3], 49.6577), ds.solve())
    ...
    #     ds = DualSimplexMethod(A, c, b, d_down_asterisk, d_up_asterisk)
    #     self.assertEqual(([1.1579, 0.6942, 0, 0, 2.8797, 0, 1.0627, 3.2055, 0], 38.7218), ds.solve())
