...
def base():
    ...
    text1 = list(binascii.unhexlify("B194BAC80A08F53B366D008E584A5DE4"))

    en = stb().encode(text1, key1)
    de = stb().decode(en, key1)
    print([hex(x) for x in en])
    print(text1, de)
    print([format(item, 'x') for item in en])
    # print('='*50)
...
def replace():
    ...
    # text = input("Message: ")
    # text1 = [ord(item) for item in text]
    # print(''.join([chr(item) for item in text1]))
